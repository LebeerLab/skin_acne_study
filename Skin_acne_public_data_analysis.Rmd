...
write.csv(skin_t_lactos, "Lactobacillus_skin_metagenomes.csv")
```
...
write.csv(oralcavity_t_lactos, "Lactobacillus_oralcavity_metagenomes.csv")
```
...
write.csv(nasalcavity_t_lactos, "Lactobacillus_nasalcavity_metagenomes.csv")
```
...
write.csv(milk_t_lactos, "Lactobacillus_milk_metagenomes.csv")
```
...
write.csv(vagina_t_lactos, "Lactobacillus_vagina_metagenomes.csv")
```
...
write.csv(stool_t_lactos, "Lactobacillus_stool_metagenomes.csv")
```
